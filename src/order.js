...
export function renderOrderDetails() {
 const rows=[['성함','예시 고객'],['연락 가능한 전화번호','010-0000-0000'],['서비스 종류','매일 릴스 솔루션'],['요금제','Standard'],['자동 게시 여부','사용함'],['기존 계정 사용 여부','사용하지 않음'],['업로드 결과 전달 채널','텔레그램'],['콘텐츠 스타일 및 내용','브랜드와 서비스를 소개하는 릴스를 매일 제작해주세요. 밝고 친근한 분위기를 원합니다. (예시)'],['필수 동의 항목','편집·외부 AI 처리, 자동 게시, 개인정보 수집 동의 (예시)'],['주의 사항 확인','확인 완료 (예시)'],['결제 금액','273,900₩ (설치비·부가세 포함 첫 달 예시)']];
